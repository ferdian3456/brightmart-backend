...
func (usecase *UserUsecase) RefreshTokenRenewal(ctx context.Context, payload model.RenewalTokenRequest, errorMap map[string]string) (model.TokenResponse, map[string]string) {
	var err error
	var respErr error
	...
	err = usecase.UserRepository.CheckUserExistenceWithTx(ctx, tx, userID)
	if err != nil {
...
func (usecase *UserUsecase) AccessTokenRenewal(ctx context.Context, payload model.RenewalTokenRequest, errorMap map[string]string) (model.AccessTokenResponse, map[string]string) {
	var err error
	var respErr error
